...
export default function BrainrotCardDuel() {
  ...
  const [showVideo, setShowVideo] = useState(false); // 🧠 Aura Boost
    ...
    try {
      ...
      if (difficulty === "hard") {
        if (aggrLevel > 0.3) logicPick = Math.max(...available);
          ...
          logicPick =
            smartCards.length > 0
              ? smartCards[Math.floor(Math.random() * smartCards.length)]
              : Math.max(...available);
        }
      }
...
Reply with ONLY a single number from your cards.`;
      ...
      const picked = parseInt(
        data.candidates[0].content.parts[0].text.trim()
      );
      if (difficulty === "hard" && available.includes(picked))
        return picked > logicPick - 2 ? picked : logicPick;
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(180deg, #080015 0%, #0e0028 35%, #160040 65%, #0a0018 100%)",
      }}
    >
      {/* Synthwave grid */}
      <div
        className="fixed bottom-0 left-0 right-0 h-72 pointer-events-none"
        style={{
      ...
      />
      <div
        className="fixed top-16 left-0 w-72 h-48 pointer-events-none"
        style={{ background: "radial-gradient(ellipse, rgba(180,0,255,0.18) 0%, transparent 70%)" }}
      />
      <div
        className="fixed top-16 right-0 w-72 h-48 pointer-events-none"
      ...
      {showEventBanner && currentEvent && (
        <div
          className="fixed top-6 left-1/2 -translate-x-1/2 z-50 px-8 py-4 rounded-2xl text-center animate-bounce"
          style={{
            background: `linear-gradient(135deg, #1a0040, #0a0020)`,
            border: `2px solid ${currentEvent.color}`,
            boxShadow: `0 0 30px ${currentEvent.color}`,
            minWidth: 320,
          }}
        >
          ...
          <div
            ...
            style={{ color: currentEvent.color, textShadow: `0 0 10px ${currentEvent.color}` }}
          >
            {currentEvent.name}
          </div>
          <div className="text-xs mt-1" style={{ color: "#ccbbdd" }}>
            {currentEvent.desc}
          </div>
        </div>
      )}

      {/* 🧠 Aura Boost Video Popup */}
      {showVideo && (
        <div
        ...
        >
          ...
          >
            ...
            <button
              ...
              className="text-xs font-black hover:scale-110 transition-all"
              style={{ color: "#ff00ff" }}
            >
              ✕
            </button>
          ...
          <iframe
            width="360"
            height="640"
            src="https://www.youtube.com/embed/N1YGgSjPByo?autoplay=1&loop=1&playlist=N1YGgSjPByo"
            title="Brainrot Aura Boost"
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 py-3">
        ...
        {!gameStarted && !gameOver && (
          ...
          >
            <div
              className="text-center max-w-md w-full mx-4 p-8 rounded-3xl overflow-y-auto"
              style={{
                background: "linear-gradient(135deg, #1a0040, #0d0020)",
                border: "2px solid #b400ff",
                boxShadow: "0 0 50px rgba(180,0,255,0.5)",
                maxHeight: "90vh",
              }}
            >
              ...
              <p className="text-xs mb-4" style={{ color: "#cc88ff" }}>
              ...
              <div className="flex gap-2 mb-4">
                {["easy", "medium", "hard"].map((d) => (
                  <button
                    ...
                    className="flex-1 py-2 rounded-xl font-black text-xs tracking-widest transition-all hover:scale-105"
                    style={{
                      background:
                        difficulty === d
                          ? d === "easy"
                            ...
                            : d === "medium"
                              ...
                              : "linear-gradient(90deg,#aa0000,#ff0055)"
              ...
              {/* How to Play */}
              <div
                className="text-left rounded-xl p-4 mb-4 space-y-1.5"
                style={{
              ...
              >
                ...
                <div className="text-xs" style={{ color: "#aa88cc" }}>
                  🎴 Each player has{" "}
                  <span style={{ color: "#ffcc00" }}>12 cards</span> numbered 1–12
                </div>
                <div className="text-xs" style={{ color: "#aa88cc" }}>
                  👁 See{" "}
                  <span style={{ color: "#ffcc00" }}>4 random cards</span> in your
                  hand at a time
                </div>
                <div className="text-xs" style={{ color: "#aa88cc" }}>
                  ⚔️ Higher number{" "}
                  <span style={{ color: "#00ff88" }}>wins</span> the round
                </div>
                <div className="text-xs" style={{ color: "#aa88cc" }}>
                  🏆 First to{" "}
                  <span style={{ color: "#ffcc00" }}>3 round wins</span> wins the
                  match
                </div>
                <div className="text-xs" style={{ color: "#aa88cc" }}>
                  ⏱ <span style={{ color: "#ff4444" }}>15 seconds</span> to pick
                  or AI auto-plays
                </div>
                <div className="text-xs" style={{ color: "#aa88cc" }}>
                  🌀{" "}
                  <span style={{ color: "#ff00ff" }}>Random events</span> trigger
                  every 3 rounds!
                </div>
              </div>
              ...
              >
                ...
                {Object.entries(SPECIAL_CARDS).map(([num, s]) => (
                  <div key={num} className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-xs" style={{ color: "#aa88cc" }}>
                      {s.desc}
                    </span>
                  </div>
                ))}
              ...
              <button
                ...
                style={{
                  background: "linear-gradient(90deg, #b400ff, #ff00cc)",
                  boxShadow: "0 0 20px rgba(180,0,255,0.6)",
                }}
              >
                ▶ PLAY
              </button>
              ...
              <button
                ...
                className="w-full py-3 mt-3 rounded-2xl font-black text-lg tracking-widest transition-all hover:scale-105"
                style={{
        ...
        {gameOver && (
          ...
          >
            <div
              className="text-center max-w-sm w-full mx-4 p-10 rounded-3xl"
              style={{
                background: "linear-gradient(135deg, #1a0040, #0d0020)",
                border: `2px solid ${playerWins >= 3 ? "#00ff88" : "#ff0055"}`,
                boxShadow: `0 0 50px ${playerWins >= 3
                  ? "rgba(0,255,136,0.5)"
                  : "rgba(255,0,85,0.5)"
                  }`,
              }}
            >
              ...
              <h2
                ...
                style={{
                  color: playerWins >= 3 ? "#00ff88" : "#ff0055",
                  textShadow: `0 0 20px ${playerWins >= 3 ? "#00ff88" : "#ff0055"
                    }`,
                }}
              >
              ...
              <p className="text-sm mb-6" style={{ color: "#cc88ff" }}>
                {playerWins >= 3
                  ...
                  : "💀 The Brainrot AI just embarrassed your entire bloodline."}
              </p>
              <div className="grid grid-cols-2 gap-3 mb-6">
                ...
                >
                  <div className="text-xs" style={{ color: "#ff0055" }}>
                    AI Wins
                  </div>
                  <div
                    className="text-3xl font-black"
        ...
        <div className="text-center mb-3">
          <h1
            ...
            style={{
              color: "#ff00ff",
              textShadow: "0 0 20px #ff00ff, 0 0 50px #b400ff",
              fontFamily: "monospace",
            }}
          >
            🧠 BRAINROT CARD DUEL
        ...
        {currentEvent && !showEventBanner && (
          <div
            className="mb-3 px-4 py-2 rounded-xl flex items-center gap-3"
            style={{
              background: `rgba(0,0,0,0.6)`,
              border: `1px solid ${currentEvent.color}`,
              boxShadow: `0 0 12px ${currentEvent.color}40`,
            }}
          >
            ...
            <div>
              ...
              <span className="text-xs ml-2" style={{ color: "#aa88cc" }}>
                {currentEvent.desc}
              </span>
            </div>
          </div>
        ...
        <div className="grid grid-cols-3 gap-3 mb-3">
          ...
          <div
            ...
            style={{
              background: "linear-gradient(135deg, #001a0a, #002a10)",
              border: "1px solid #006622",
              boxShadow: "0 0 16px rgba(0,160,60,0.3)",
            }}
          >
            <div
            ...
            <div className="relative">
              ...
              <div className="text-xs" style={{ color: "#2a7a50" }}>
                Round Wins
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex items-center gap-1 mb-1 justify-start">
              ...
              <span
                className="text-xs"
                style={{ color: "#cc7744", fontSize: "10px" }}
              >
                AI adapting ({smartPct}%)
              </span>
            </div>
            <div className="text-left">
              <div className="flex items-center gap-1 mb-0.5">
                <span style={{ color: "#aa6633", fontSize: "9px" }}>
                  ⚡ AI Aggression Profile
                </span>
                <span
                  className="ml-auto"
                  style={{ color: "#aa6633", fontSize: "9px" }}
                >
                  ({aggrPct}%)
                </span>
              </div>
          ...
          >
            <div
              ...
              style={{
                backgroundImage:
                  "linear-gradient(rgba(200,0,255,1) 1px,transparent 1px),linear-gradient(90deg,rgba(200,0,255,1) 1px,transparent 1px)",
                backgroundSize: "18px 18px",
              }}
            />
            <div className="relative">
              ...
              <div
                ...
                style={{
                  color: "#cc88ff",
                  textShadow: "0 0 12px #aa00ff",
                  fontFamily: "monospace",
                }}
              >
                {aiWins}
              </div>
              <div className="text-xs mb-2" style={{ color: "#7744aa" }}>
                Round Wins
              </div>
              <div
        ...
        >
            ...
            {lastBattle?.specialName && (
              <span
                ...
                style={{
                  ...
                  border: `1px solid ${lastBattle.specialColor || "#ffcc00"}`,
                  color: lastBattle.specialColor || "#ffcc00",
                }}
              >
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(160deg,#c8a86a,#b8943a,#d4b870,#b09040,#c8a860)",
                border: "2px solid #8a6820",
                boxShadow: "inset 0 0 30px rgba(80,40,0,0.6)",
                minHeight: 120,
              }}
            >
              <div className="relative p-3 flex flex-col items-center justify-center h-full">
                <div
                  ...
                  style={{ color: "#4a2800", letterSpacing: "0.08em" }}
                >
                  Your Card
                </div>
                {lastBattle ? (
                  <div className="relative">
                    ...
                    />
                    <div
                      className="absolute bottom-0 left-1/2 -translate-x-1/2 font-black rounded px-2 py-0.5"
                      style={{
                    ...
                    {SPECIAL_CARDS[lastBattle.playerCard] && (
                      <div
                        ...
                        style={{
                          background:
                            SPECIAL_CARDS[lastBattle.playerCard].color,
                          color: "#000",
                          fontSize: 9,
                        }}
                      >
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(160deg,#16003a,#220055,#180040,#0e0028)",
                border: "2px solid #5500aa",
                boxShadow: "inset 0 0 25px rgba(100,0,200,0.3)",
                minHeight: 120,
              }}
            >
              <div className="relative p-3 flex flex-col items-center justify-center h-full">
                <div
                  className="text-xs font-bold mb-2"
                  style={{ color: "#aa77ff", letterSpacing: "0.08em" }}
                >
                  AI Card
                </div>
                {lastBattle ? (
                  <div
                    className="card-flip relative"
                    style={{ width: 80, height: 96 }}
                  >
                    <div
                      className={`card-flip-inner w-full h-full ${aiCardFlipped ? "flipped" : ""
                        }`}
                    >
                      <div
                        className="card-front w-full h-full rounded flex items-center justify-center text-3xl"
                        style={{
                          background:
                            "linear-gradient(135deg,#2a0055,#1a0035)",
        ...
        <div
          ...
          style={{
            background: "linear-gradient(180deg,#2a2a2a,#1e1e1e,#282828)",
          ...
          >
            <div>
              <div className="flex items-center gap-2">
                ...
                <span style={{ color: "#886699", fontSize: 11 }}>
                  SELECT YOUR BRAINROT DESTINY
                </span>
              </div>
              <div style={{ color: "#554466", fontSize: 10, marginTop: 2 }}>
            ...
            <div className="flex items-center gap-2 shrink-0 ml-3">
              ...
              <button
                onClick={() => setShowVideo(!showVideo)}
                className="px-3 py-1.5 rounded-lg font-bold text-xs transition-all hover:scale-105"
                style={{
                  ...
                  color: "#ff00ff",
                  boxShadow: showVideo ? "0 0 12px #ff00ff" : "none",
                }}
              >
                {showVideo ? "💀 KILL AURA" : "🧠 BOOST AURA"}
              </button>
              <button
                onClick={resetGame}
                className="px-3 py-1.5 rounded-lg font-bold text-xs transition-all hover:scale-105"
                ...
                <div
                  ...
                  style={{
                    ...
                    background:
                      timeLeft <= 5
                        ? "#ff0055"
                        : "linear-gradient(90deg,#b400ff,#ff00cc)",
                    boxShadow:
                      timeLeft <= 5 ? "0 0 5px #ff0055" : "0 0 5px #ff00ff",
                  }}
                />
              </div>
              <span
                style={{
                  color: timeLeft <= 5 ? "#ff0055" : "#ff00ff",
                  fontSize: 10,
                  fontWeight: "bold",
                  minWidth: 24,
                  textAlign: "right",
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      border: `1px solid ${special ? special.color : "rgba(180,0,255,0.5)"
                        }`,
                      boxShadow: special
                        ? `0 0 12px ${special.color}66`
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.boxShadow = `0 10px 24px rgba(0,0,0,0.8), 0 0 22px ${special ? special.color : "rgba(255,0,255,0.55)"
                        }`;
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.transform = "";
                  ...
                  >
                    <img
                      ...
                      style={{
                        ...
                        objectFit: "contain",
                        display: "block",
                        filter: isBlind ? "brightness(0.1)" : "none",
                      }}
                    />
                    {!isBlind && (
                      <div
                        className="absolute bottom-1 left-1/2 -translate-x-1/2 font-black rounded px-2 py-0.5"
                        style={{
                          background: "rgba(0,0,0,0.9)",
                          border: `1px solid ${special ? special.color : "#9900ee"
                            }`,
                          color: special ? special.color : "#ee00ff",
                          fontSize: 11,
                          whiteSpace: "nowrap",
                        }}
                      >
        ...
        {/* AI Strategy strip */}
        <div
          className="px-4 py-2 mb-3 text-center rounded-b-xl"
          style={{
        ...
        >
          <div style={{ color: "#665577", fontSize: 11 }}>
            AI Strategy Detected: {getAiMood()}
          </div>
          <div style={{ color: "#443355", fontSize: 10 }}>
            Ready for your turn!
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
              ...
              {[
                {
                  ...
                  val: smartPct,
                  color: "#00ccff",
                  bar: "linear-gradient(90deg,#b400ff,#ec4899)",
                },
                {
                  label: "😈 Aggression Read",
                  val: aggrPct,
                  color: "#f59e0b",
                  bar: "linear-gradient(90deg,#22d3ee,#f59e0b)",
                },
                {
                  label: "🎯 Rounds Analyzed",
                  val: Math.min((aiMemory.roundsObserved / 10) * 100, 100),
                  color: "#4ade80",
                  bar: "linear-gradient(90deg,#4ade80,#22d3ee)",
                  label2: `${aiMemory.roundsObserved}/10`,
                },
              ].map((item) => (
                <div key={item.label}>
                  <div
                    className="flex justify-between mb-1"
                    style={{ fontSize: 10, color: "#4477aa" }}
                  >
          ...
          >
            ...
            >
              {history.length === 0 && (
                <div style={{ color: "#443355", fontSize: 11 }}>
              ...
              {history.map((entry, idx) => (
                <div
                  ...
                  style={{
                    ...
                    border: "1px solid rgba(140,0,255,0.18)",
                  }}
                >
                  <div>
                    <div
                      className="font-bold"
                      style={{ color: "#ccaaee", fontSize: 11 }}
                    >
                      Round {entry.round}
                      {entry.special && (
                        <span
                          className="ml-1"
                          style={{ color: "#ffcc00", fontSize: 9 }}
                        >
                          ✨{entry.special}
                        </span>
                      )}
                    ...
                    <div style={{ color: "#664488", fontSize: 10 }}>
